		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#jmcoronelinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jmcoronelinvoices-display": {
								"semanticObject": "jmcoronelinvoices",
								"action": "display",
								"description": "Invoices List Test JMCoronel",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jmcoronel.invoices",
									"url": sap.ui.require.toUrl("jmcoronel/invoices")
								}
							}
						}
					}
